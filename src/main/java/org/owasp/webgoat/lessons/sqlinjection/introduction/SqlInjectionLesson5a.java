...
public class SqlInjectionLesson5a implements AssignmentEndpoint {
  ...
  protected AttackResult injectableQuery(String accountName) {
    ...
    try (Connection connection = dataSource.getConnection()) {
      // last_name was concatenated into the statement, so the submitted account name could close
      // the quote and add its own condition. Bound, it stays a value to compare against.
